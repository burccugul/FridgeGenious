...
class SupabaseHelper {
  ...
  Future<List<Map<String, dynamic>>> getInventoryByUserId(String uuidUserId) async {
    await initialize();
  ...
  Future<List<Map<String, dynamic>>> getShoppingListByUserId(String uuidUserId) async {
    await initialize();
